  ...
  <![endif]-->
    ...
    <div id="wrapper" class="wrapper brown-3">
        ...
        <main class="page-content">
            <!-- My Account Page -->
            <div class="my-account-area pt--70 pb--150 bg_color--1 pt-xs-20">
                <div class="container">
                    <div class="row">
                        <!-- Login Form -->
                        <div class="col-lg-6">
                            <div class="login-form-wrapper">
                                <form action="javascript:void(0);" class="sn-form sn-form-boxed" id="formLogin">
                                    <div class="sn-form-inner">
                                        ...
                                        <div class="single-input">
                                            ...
                                            <!--<div class="checkbox-input">
                                                ...
                                                <label for="login-form-remember">Recordarme me</label>
                                            </div>-->
                                        </div>
                                        <div class="single-input">
                                            <a href="#" id="recuperarPass">¿Olvidaste tu contraseña?</a>
                                    ...
                                    <!--<input type="submit" name="" id="enviarLogin" hidden>-->
                                </form>
                            </div>
                        </div>
                        <!--// Login Form -->
                            ...
                            <div class="login-form-wrapper">
                                <form action="javascript:void(0);" class="sn-form sn-form-boxed" id="formRegistro">
                                    <div class="sn-form-inner">
                                        ...
                                        <div class="single-input">
                                            <label for="register-form-user">Usuario</label>
                                            <input type="text" name="register-form-user" id="register-form-user" required>
                                        </div>
                                        <div class="single-input">

...
if (!isset($_COOKIE["lotto_lg"]))
    header("Location: login-register.php?r=acc");
  ...
  <![endif]-->
    ...
    <div id="wrapper" class="wrapper brown-3">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="breadcaump-inner text-center">
                            <h1 class="heading heading-h1">Mi cuenta</h1>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <main class="page-content">
            ...
            <div class="my-account-area pt--120 pb--90 pt-xs-20 pb-xs-150">
                <div class="container">
                    <div class="row">
                                ...
                                <div id="faq" class="panel-group">
                                    <div class="panel panel-default">
                                        <div class="panel-heading">
                                            <h5 class="panel-title">
                                                <span>1</span>
                                                <a data-toggle="collapse" data-parent="#faq" href="#my-account-1">Editar
                                                    mis datos </a>
                                            </h5>
                                        </div>
                                        <div id="my-account-1" class="panel-collapse collapse show">
                                            <div class="panel-body">
                                                <div class="billing-information-wrapper">
                                                    ...
                                                    <form id="formDatosPersonales" action="javascript:void(0);">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6 col-12 mb--20">
                                                                <div class="billing-info">
                                                                    ...
                                                                    <input type="text" name="telefono" required id="telefono" maxlength="10">
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-12 mb--20">
                                                                <div class="billing-info">
                                                                    ...
                                                                    <input type="text" placeholder="Dirección línea 1" name="direccion1" required>
                                                                    <input type="text" placeholder="Dirección línea 2" name="direccion2">
                                                                </div>
                                                            </div>
                                    ...
                                    <div class="panel panel-default">
                                        <div class="panel-heading">
                                            <h5 class="panel-title">
                                                <span>2</span>
                                                <a data-toggle="collapse" data-parent="#faq" href="#my-account-2">Cambiar mi contraseña </a>
                                            </h5>
                                        </div>
                                            ...
                                            <div class="panel-body">
                                                <div class="billing-information-wrapper">
                                                    ...
                                                    <div class="billing-back-btn">
                                                        ...
                                                        <div class="billing-btn">
                                                            <button type="submit" id="guardarPass">Guardar</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
    ...
    <script type="text/javascript" src="server/controllers/mi-cuenta_1658177167.js"></script>
